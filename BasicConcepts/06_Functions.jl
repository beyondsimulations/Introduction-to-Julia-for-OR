...
# use anonymous functions, and leverage multiple dispatch for versatile function behavior.
...
# After the keyword, you name the function and write the parameters in parentheses. For example:
# function multiply(a,b)
#   a * b
# end
# This function takes two parameters, multiplies them, and returns the result implicitly.
# In Julia, the last expression is automatically returned, making the 'return' keyword optional.
...
# If you want to access the variable outside of the function, you have to explicitly return it.
# You can do this by passing 'return' in front of the variable you want to return from the function.
...
## Exercise 2.2: Define and Test an Implicit Return Function
# Define a function 'subtract' that takes two parameters and implicitly returns their difference.
# The implicit return feature makes your code cleaner and more concise.
...
# They are particularly useful for operations that are passed as arguments to higher-order functions or used for short, one-off computations.
# Syntax for anonymous functions can be either of the following:
# add_two = (a,b) -> a + b
# or
# add_two(a,b) = a + b

## Exercise 3.1: Define and Test an Anonymous Function
...
println("You now have a first understanding of how to create, use, and understand functions in Julia.")
